...
class AchievementLogicTests(AppTestCase):
    ...
    def test_bookworm_achievement_awarded(self):
        with self.app.app_context(): # AppTestCase provides self.app
            ...
            self.assertIsNone(
                user_ach_check1,
                "Bookworm achievement should not be awarded after 4 bookmarks.",
            )
            ...
            self.assertIsNotNone(
                user_ach_check2,
                "Bookworm achievement should be awarded after 5 bookmarks.",
            )
            ...
            self.assertEqual(
                count_after_second_call,
                1,
                "Bookworm achievement should not be awarded again.",
            )
    ...
    def test_well_connected_achievement_awarded(self):
        with self.app.app_context(): # AppTestCase provides self.app
            ...
            self.assertIsNone(
                user_ach_check1,
                "Well-Connected achievement should not be awarded after 4 friends.",
            )
            ...
            self.assertIsNotNone(
                user_ach_check2,
                "Well-Connected achievement should be awarded after 5 friends.",
            )
            ...
            self.assertEqual(
                count_after_second_call,
                1,
                "Well-Connected achievement should not be awarded again.",
            )
    ...
    def test_opinion_leader_achievement_awarded(self):
        with self.app.app_context(): # AppTestCase provides self.app
            ...
            self.assertIsNone(
                user_ach_check1,
                "Opinion Leader achievement should not be awarded after voting in 4 polls.",
            )
            ...
            self.assertIsNotNone(
                user_ach_check2,
                "Opinion Leader achievement should be awarded after voting in 5 polls.",
            )
            ...
            self.assertEqual(
                count_after_second_call,
                1,
                "Opinion Leader achievement should not be awarded again.",
            )
